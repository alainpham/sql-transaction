...
public class RestConfigurator extends RouteBuilder {
	...
	public void configure() throws Exception {
        ...
        servletComponent.setServletName("CamelServlet-sql-transaction");

		restConfiguration()
		.component("servlet")
		.bindingMode(RestBindingMode.auto)
		.contextPath("/sql-transaction/camel")
        ...
        .apiProperty("api.title", "sql-transaction")
